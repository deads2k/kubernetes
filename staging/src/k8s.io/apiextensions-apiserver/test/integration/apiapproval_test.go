...
func TestAPIApproval(t *testing.T) {
	...
	if noxuAPIApproved := findCRDCondition(noxuDefinition, apiextensionsv1beta1.KubeAPIApproved); noxuAPIApproved != nil {
	...
	err = wait.PollImmediate(100*time.Millisecond, 30*time.Second, func() (bool, error) {
		...
		if approvedKubeAPIApproved := findCRDCondition(approvedKubeAPI, apiextensionsv1beta1.KubeAPIApproved); approvedKubeAPIApproved == nil || approvedKubeAPIApproved.Status != apiextensionsv1beta1.ConditionTrue {
