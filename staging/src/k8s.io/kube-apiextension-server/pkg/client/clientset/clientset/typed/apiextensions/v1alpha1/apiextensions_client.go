...
import (
	...
	"k8s.io/kube-apiextension-server/pkg/client/clientset/clientset/scheme"
)
...
func (c *ApiextensionsV1alpha1Client) ThirdParties() ThirdPartyInterface {
	return newThirdParties(c)
}
